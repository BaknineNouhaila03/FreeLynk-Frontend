        ...
        try {
            if (isBookmarked) {
                ...
                const response = await fetch(
                    `http://localhost:8081/api/savedFreelancers/remove?clientId=${freelancer.clientId}&freelancerId=${freelancer.id}`,
                    {
                        method: 'DELETE',
                        headers: {
                ...
                const response = await fetch(
                    `http://localhost:8081/api/savedFreelancers/save?clientId=${freelancer.clientId}&freelancerId=${freelancer.id}`,
                    {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
