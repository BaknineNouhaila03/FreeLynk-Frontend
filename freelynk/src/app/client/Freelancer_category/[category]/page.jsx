...
export default function Freelancer_category() {
  ...
  useEffect(() => {
    const fetchFreelancers = async () => {
      ...
      try {
        setLoading(true);
        const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/freelancers/category/${category}`);
                ...
                <div className={styles.freelancerInfo}>
                  ...
                  <div className={styles.freelancerDetails}>
                    ...
                    <div className={styles.freelancerTitle}>
                      ...
                      <span className={styles.rating}>({freelancer.rating || 'N/A'})</span>
